...
-- Records of fa_admin
-- ----------------------------
INSERT INTO `fa_admin` VALUES (1, 'admin', 'Admin', '4c39215188c0d057d3160fe6e30e7296', '5e0721', '/assets/img/avatar.png', 'admin@admin.com', 0, 1614648840, '127.0.0.1', 1492186163, 1614648840, '7e967005-dd85-4e5f-8146-edd16327b664', 'normal');
...
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '管理员日志表' ROW_FORMAT = Dynamic;
...
INSERT INTO `fa_config` VALUES (20, 'fxiaoke', 'basic', '纷享销客CRM配置', '', 'array', '{\"appId\":\"\",\"appSecret\":\"\",\"permanentCode\":\"\"}', '{\"value1\":\"title1\",\"value2\":\"title2\"}', '', '', '{\"table\":\"\",\"conditions\":\"\",\"key\":\"\",\"value\":\"\"}');
